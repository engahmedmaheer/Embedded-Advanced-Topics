...
clean-Src:
	-$(RM) ./Src/NVIC_Program.cyclo ./Src/NVIC_Program.d ./Src/NVIC_Program.o ./Src/NVIC_Program.su ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
